...
| [Images](#links--images) | `![](https://amazon.com/favicon.ico)` | ![](https://amazon.com/favicon.ico) |
  | [Code Blocks](#code-blocks) | <pre>\`\`\`md<br>\*\*bold\*\* \_italic\_ \`code\`<br>\`\`\`</pre> <pre>\`\`\`\`\`md<br>\`\`\`md<br>\*\*bold\*\* \_italic\_ \`code\`<br>\`\`\`<br>\`\`\`\`\`</pre> | <pre language="markdown"><code>**\*\*bold\*\*** _\_italic\__ <code>\`code\`</code></pre> <br><br> <pre language="markdown"><code>\`\`\`md <br>\*\*bold\*\* \_italic\_ \`code\` <br>\`\`\`</code></pre> |
| Horizontal Rule | --- | <hr> |
